...
export async function GET() {
    ...
    const backgroundData = env.NODE_ENV === 'development' ? await promises.readFile('./assets/fuel_pulse_og_background.png') : await fetch(
        new URL('../../../assets/fuel_pulse_og_background.png', import.meta.url),
    ).then((res) => res.arrayBuffer());


    // Convert ArrayBuffer to Buffer
    const buffer = Buffer.from(backgroundData);
    ...
    return new ImageResponse(
        (
            <div tw="h-full w-full flex flex-col items-center justify-center relative bg-white">
                <img
